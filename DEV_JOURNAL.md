This Dev's journal would document my ideas and initial designs/ thoughts for the VEX driving simulator I'm working on in "main.py".
...
---Why Option 2 Wins--- After digging into PyMunk’s documentation and seeing what the library can do, I naturally landed on Option 2. It lets PyMunk handle the heavy math under the hood rather than forcing me to manually track independent directional forces every frame for Option 1:
